...
/**
 * An AI that uses an Alpha-beta pruning algorithm.
 * Uses a specific evaluation function (different from AlphaBetaT)
 *
 * @author Richard
 */
public class AlphaBetaO extends AI {
    ...
    public int alphabetaHelper(int player, Board board) {
        ...
        switch(moves.size()) {
            case 7: depth = 7; break;
            case 6: depth = 8; break;
            case 5: depth = 9; break;
            case 4: depth = 10; break;
            case 3: depth = 13;break;
            case 2: depth = 20;break;
            default: depth = 8;
        }
